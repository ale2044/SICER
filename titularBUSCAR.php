...
<form action="titularBUSCAR.php" name="formulario" id="formulario" method="POST">
            	<input type="text" name="dato_titu" size="17" maxlength="11" value="CUIL, APELLIDO o NOMBRE" 
...
if(is_numeric($buscar)){
	$resul1 = mysql_query("select CUIL, TNOMB, TAPEL from titulares where CUIL like '%$dato_titu%' ORDER BY CUIL");
	?>
